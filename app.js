...
var Controller = (function (budgetCtrl, UIcotrl) {

    var setupEventListener = function () {

        var DOM = UIcotrl.getDomString();
    ...
    var ctrlAddItem = function () {
        ...
        if (input.description !== "" && !isNaN(input.number) && input.number>0) {
            ...
            UIcotrl.addListItem(newItem, input.type);
...
})(budgetController, UIcontrroller);
